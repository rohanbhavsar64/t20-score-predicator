...
image_path1 = 'https://www.youtube.com/watch?v=urJP8gsj8vI'  # Use .values[0] to get the first element
...
st.video(image_path1, format="video/mp4", start_time=0, subtitles=None, end_time='34s', loop=False, autoplay=False, muted=False)
